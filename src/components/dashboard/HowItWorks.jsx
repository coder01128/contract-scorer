...
export default function HowItWorks({ onTryIt, onClose }) {
  ...
  return (
    <div className="hiw-overlay" onClick={handleDismiss}>
      <div className="hiw-modal" onClick={e => e.stopPropagation()}>
        <button className="hiw-close" onClick={handleDismiss}>&times;</button>
        ...
        <div className="hiw-cta">
          <button className="btn btn-primary btn-lg" onClick={handleTryIt}>
            Try It Now
          </button>
